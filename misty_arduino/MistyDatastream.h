#ifndef Misty_DATASTREAM_H
#define Misty_DATASTREAM_H
...
class MistyDatastream : public Printable {
  friend class MistyHttpClient;
...
public:
  ...
  MistyDatastream(String& aId, int aType);
  MistyDatastream(char* aIdBuffer, int aIdBufferLength, int aType);
  MistyDatastream(char* aIdBuffer, int aIdBufferLength, int aType, char* aValueBuffer, int aValueBufferLength);
